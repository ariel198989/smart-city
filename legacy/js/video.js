// Smart City — video → sharp frames (proven thinkCV pipeline:
// decoder priming, rVFC seek settle, black-frame retry, Laplacian sharpness)
export function blurScore(srcCtx, W, H) {
 ...
 * Returns [{url, t, score}] — t is the video-timestamp (sec), needed for GPX geotagging.
 */
export async function extractFrames(file, { want = 60, sharpOnly = true, maxW = 640, onProgress = () => {}, videoEl = null } = {}) {

...
export default function AboutPage() {
  return (
    <main className="ld" dir="rtl">
      ...
      <section className="ld-sec" id="value">
        <h2 className="ld-h2">מה יוצא לעיר מזה</h2>
        <p className="ld-lead">
          לא עוד אפליקציית דיווחים. תשתית שהופכת את התושבים הצעירים למערך החישה
          הזול, המהיר והמסור ביותר שיש לעיר — וכל שקל בה עובד ארבע פעמים.
        </p>
        <div className="ld-value">
          <article className="ld-val big">
            <b>תיקון מוקדם עולה עשירית מתיקון מאוחר</b>
            <p>
              בור קטן שמדווח היום הוא טלאי של מאות שקלים. אותו בור בעוד חצי שנה
              הוא קרע בתשתית, רכב ניזוק — ותביעת נזיקין. כל מפגע שנתפס מוקדם
              על ידי ילד עם טלפון הוא הוצאה שנמנעה מתקציב העירייה, וכל התהליך
              מתועד: דווח, טופל, אומת בשטח. בתביעת "העירייה ידעה ולא עשתה" —
              יש לעירייה תשובה חתומה.
            </p>
          </article>
          <article className="ld-val">
            <b>אלפי עיניים במחיר של אפס ניידות</b>
            <p>פקח מכסה רחוב בשעה. מאה תלמידים בדרך הביתה מכסים את כל העיר, כל יום — וה-AI מסנן להם את הרעש לפני שהוא מגיע למוקד.</p>
          </article>
          <article className="ld-val">
            <b>תקציב שנשען על דאטה, לא על תחושה</b>
            <p>מפת חום של התשתיות הכושלות באמת: איפה מצטברים המפגעים, מה נסגר ומה נגרר. תיעדוף שיפוצים שמחזיק מים מול מועצה ומול מבקר.</p>
          </article>
          <article className="ld-val">
            <b>מוקד 106 עם חיישן קדמי</b>
            <p>הדיווחים מגיעים מסוננים, ממוקמים ב-GPS מדויק ועם תמונה מאומתת — פחות קריאות סרק, פחות נסיעות ביקורת, זמן טיפול קצר יותר.</p>
          </article>
          <article className="ld-val">
            <b>דור שמרגיש שהעיר שלו</b>
            <p>ילד שהפין שלו ירד מהמפה כי העירייה תיקנה — הוא תושב שראה את השלטון המקומי עובד. חינוך אזרחי וטכנולוגי אמיתי, בלי תקציב חינוך נוסף.</p>
          </article>
        </div>
        <div className="ld-val-banner">
          <p>
            והסיפור עצמו שווה זהב: <b>העיר הראשונה בישראל שהילדים שלה מאמנים לה בינה מלאכותית.</b>
            כותרת מוכנה לתקשורת, תיק מושלם לקולות קוראים של חדשנות ודיגיטל.
          </p>
        </div>
      </section>
